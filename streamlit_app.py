...
st.info('Please select any one from Sidebar which you want')
...
st.write('3 :- Netflix stock Prediction')
st.write('4 :- Netflix stock Prediction')
st.write('5 :- Netflix stock Prediction')
